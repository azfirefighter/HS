...
PKG_VERSION="9e2193537c"
PKG_SITE="https://github.com/raspberrypi/firmware/tree/master"
...
makeinstall_target() {
  ...
  cp -PR boot/fixup4cd.dat $PKG_BUILD/.boot/fixup4.dat
  cp -PR boot/start4cd.elf $PKG_BUILD/.boot/start4.elf
